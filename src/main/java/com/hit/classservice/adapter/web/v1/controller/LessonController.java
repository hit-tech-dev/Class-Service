...
public class LessonController {
   ...
   * @throws Exception
   */
  @Operation(summary = "API get list lesson by subject id")
  @ApiResponses(value = {
      ...
      @ApiResponse(responseCode = "500", description = "Subject Id not exist", content = {
   ...
   * @throws Exception
   */
  @Operation(summary = "API update lesson")
  @ApiResponses(value = {
      ...
      @ApiResponse(responseCode = "500", description = "Updated failed, some fields has errors", content = {
          @Content(mediaType = CommonConstant.APPLICATION_JSON_TYPE,
              schema = @Schema(implementation = RestData.class))
      })
  })
   ...
   */
  @Operation(summary = "API get list lessons detail by subject Id")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Found the list lessons detail",
          content = {@Content(mediaType = CommonConstant.APPLICATION_JSON_TYPE,
